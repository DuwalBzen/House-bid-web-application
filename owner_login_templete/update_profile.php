...
$query_for_profile_update="UPDATE `owner_login` SET `first_name`='{$first_name}',`last_name`='{$last_name}',`address`='{$address}',`contact_no`='{$contact_no}',`email`='{$email}',`password`='{$password}' WHERE email='$email'";
